...
class AdjustController extends Controller
{
    ...
    {
        $title = 'Adjust List';
        return view('backend.pages.inventories.adjust.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.inventories.adjust.create', get_defined_vars());
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inventorySetup.adjust.index');
    }
    /**
     * @param $slug
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.inventories.adjust.edit', get_defined_vars());
    }
