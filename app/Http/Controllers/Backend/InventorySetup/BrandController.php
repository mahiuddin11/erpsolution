...
class BrandController extends Controller
{
    ...
    {
        $title = 'Brand List';
        return view('backend.pages.inventories.brand.index', get_defined_vars());
    }
    ...
    {
        $title = 'Add New Brand';
        return view('backend.pages.inventories.brand.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $title = 'Add New Brand';
        return view('backend.pages.inventories.brand.edit', get_defined_vars());
    }
