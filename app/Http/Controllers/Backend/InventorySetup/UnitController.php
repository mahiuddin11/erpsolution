...
class UnitController extends Controller
{
     ...
     * @param UnitService $systemTransformer
     */
    ...
    public function index(Request $request)
    {
        ...
        $title = 'Unit List';
        return view('backend.pages.inventories.unit.index', get_defined_vars());
    }
    ...
    {
        $title = 'Add New Unit';
        return view('backend.pages.inventories.unit.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.inventories.unit.edit', get_defined_vars());
    }
