...
class StoreController extends Controller
{
     ...
     */
    public function __construct(BranchService $branchService,StoreService $storeService, StoreTransformer $storeTransformer)
    {
    ...
    {
        $title = 'Store List';
        return view('backend.pages.settings.store.index', get_defined_vars());
    }
    ...
    public function create()
    {
       ...
       $branch = $this->branchService->getAllBranch();
        return view('backend.pages.settings.store.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $title = 'Add New Store';
        $branch = $this->branchService->getAllBranch();
        return view('backend.pages.settings.store.edit', get_defined_vars());
    }
