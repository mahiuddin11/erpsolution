...
class BranchController extends Controller
{
    ...
    {
        $title = 'Branch List';
        return view('backend.pages.settings.branch.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.settings.branch.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $title = 'Edit Branch';
        return view('backend.pages.settings.branch.edit', get_defined_vars());
    }
