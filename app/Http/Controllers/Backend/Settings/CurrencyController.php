...
class CurrencyController extends Controller
{
    ...
    {
        $title = 'Currency List';
        return view('backend.pages.settings.currency.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.settings.currency.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $title = 'Add New Currency';
        return view('backend.pages.settings.currency.edit', get_defined_vars());
    }
