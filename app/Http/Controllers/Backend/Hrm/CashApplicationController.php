...
use App\Models\Lone;
use App\Services\Hrm\CashApplicationService;
...
class CashApplicationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.pages.hrm.cash_application.index', get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        $branches = Branch::get();
        return view('backend.pages.hrm.cash_application.create', get_defined_vars());
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $branches = Branch::all();
        $model = CashReq::findOrFail($id);
        return view('backend.pages.hrm.cash_application.edit', get_defined_vars());
    }
    ...
    public function show(CashReq $lone)
    {
        ...
        $title = 'Cash Requisition Details';
        return view('backend.pages.hrm.cash_application.details', get_defined_vars());
    }
