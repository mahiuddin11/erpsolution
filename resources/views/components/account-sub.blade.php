@foreach ($subacounts as $account)
    <ul class="nested">
        <li>
            ...
            <a href="{{ route('settings.account.destroy', $account->id) }}" onclick="return confirm('Are you sure?')"
                class="btn btn-sm "> <i style="color: red" class="fas fa-trash folder-icone rotate"></i></a>
