...
@section('content')
        ...
        @endif
        <form action="{{route('attends.store')}}" method="POST" enctype="multipart/form-data" style="margin-top: 20px">
            @csrf
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="from-group">
                        <strong>Emplyee_ID</strong>
                        <input type="text" name="emplyee_id" class="form-control" placeholder="Emplyee_ID">
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <input type="time" class="form-control input-rounded" value="{{old('sign_in')}}" name="name">
                                    @error('sign_in')
                                    <span class=" error text-red text-bold">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4 mb-1">
                                    ...
                                    <input type="time" class="form-control input-rounded" value="{{old('sign_out')}}" name="name">
                                    @error('sign_out')
                                    <span class=" error text-red text-bold">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4 mb-1">
                                    ...
                                    <input type="text" class="form-control input-rounded" value="{{old('status')}}" name="name">
                                    @error('status')
                                    <span class=" error text-red text-bold">{{ $message }}</span>
                                    @enderror
                                </div>
