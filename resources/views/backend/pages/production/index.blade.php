        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('Production.Production.index') }}">Production</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Production List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
@endsection
@section('scripts')
@include('backend.pages.production.script')
@endsection