        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('hrm.leave.index') }}">Salary Sheet
                            List</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Leave Application</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <form class="needs-validation" method="POST" action="{{ route('hrm.leave.store') }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="row">
                        ...
                        <h4>  {{ auth()->user()->employee->name ?? "" }}</h4>
                         <input type="hidden" name="employee_id" value="{{auth()->user()->employee->id ?? 0}}">
                        @else
