...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // ============================================================
            // Render Preview (unchanged logic, শুধু buildPreviewTable call এ removeId pass)
            // ============================================================
            function renderPreview(data) {
                ...
                if (!hasData) {
                    ...
                    // Added: 2026-06-27 — preview render হওয়ার পর সব table এর detail auto-load
                    autoLoadAllDetails();
                }
            ...
            // ============================================================
            // Added: 2026-06-27
            // buildPreviewTable — detail section সরাসরি table এর নিচে থাকবে
            // button নেই, auto-load হবে
            // ============================================================
            ...
            // ============================================================
            // Added: 2026-06-27
            // autoLoadAllDetails — preview render হওয়ার পর সব .detail-section
            // একসাথে AJAX করে data load করবে
            // ============================================================
                ...
                $('.detail-section').each(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            // Added: 2026-06-27 — tableColumnMap থেকে important columns নাও
                            // map এ না থাকলে সব columns দেখাও
            ...
            // ============================================================
            // Added: 2026-06-27
            // Print — details সহ সব কিছু print হবে
            // ============================================================
            ...
            // ============================================================
            // Render Merge Success (unchanged)
            // ============================================================
