                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col" style="text-align:right">
                                ...
                                {{-- <b>Branch : {{ $invoice->branch->branchCode ?? 'N/A' }} - {{ $invoice->branch->name ?? 'N/A' --}}
                                }} -
                                ({{ $invoice->branch->phone ?? 'N/A' }})</b><br>
                                <b> Project :</b> {{ $invoice->projects->name ?? 'N/A' }}<br>
                            </div>
                            <!-- /.col -->
                        </div><br>
                        <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($projectDetails as $detail)
                                            @php
                                                $qty += $detail->qty;
                                                $totalunitprice += $detail->unit_price;
