        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('project.Productrequisition.index') }}">Project
                            List</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Product Requisition</span></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Add New Product Requisition</h3>
                <div class="card-tools">
                    @if (helper::roleAccess('project.Productrequisition.index'))
                    <a class="btn btn-default" href="{{ route('project.Productrequisition.index') }}"><i
                            class="fa fa-list"></i>
                        Product Requisition List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('project.Productrequisition.store') }}"
                    novalidate>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <span class="bg-green" style="padding: 5px; font-weight : bold"
                                for="validationCustom01">Requisition Code * : {{ $requisitionCode }}</span>
                            <input type="hidden" name="requisitionCode" class="form-control" id=""
                    ...
                    <table class="table table-bordered table-hover" id="show_item">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control text-right qnty reset_qty"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('input', '.unitprice', function () {
            ...
            let qty = number_format(parent.find('.qnty').val());
        ...
        $(document).on('click', '#add_item', function () {
            ...
            var qty = number_format(parent.find('.qnty').val());
