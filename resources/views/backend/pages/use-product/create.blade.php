    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Add New Use product</h3>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('project.productuse.store') }}"
                    novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <span class="bg-green" style="padding: 5px; font-weight : bold"
                                for="validationCustom01">Product Use * : {{ $puInv }}</span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.project_id').on('change', function () {
            var self = $(this).val();
            $.ajax({
                url: "{{route('project.productuse.getstockdata')}}",
                method: "GET",
                data: {
                    "_token": "{{csrf_token()}}",
                    project_id: self
