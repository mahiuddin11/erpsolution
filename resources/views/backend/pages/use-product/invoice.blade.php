        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Project use List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col" style="text-align:right">
                            ...
                            <b> Project :</b> {{ $invoice->project->name ?? 'N/A' }}<br>
                        </div>
                        <!-- /.col -->
                    </div><br>
                    <!-- /.row -->
                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right">Use Product</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                                    ...
                                    $totaluseqty=0;
                                    @endphp
                                    @foreach ($productuseDetails as $detail)
                                    @php
                                    $totalstock +=$detail->stock_qty;
                                    $totaluseqty +=$detail->use_qty;
                                    @endphp
                                    <tr>
