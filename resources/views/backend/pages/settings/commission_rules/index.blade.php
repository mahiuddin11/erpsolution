        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('settings.commissionRules.index') }}">Commission Rules</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Commission Rules List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
@endsection
@section('scripts')
@include('backend.pages.settings.commission_rules.script')
@endsection