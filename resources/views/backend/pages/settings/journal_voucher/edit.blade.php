            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @endif
                        <li class="breadcrumb-item active"><span>Edit Journal Voucher</span></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @if (helper::roleAccess('settings.journal.voucher.create'))
                            <a class="btn btn-default" href="{{ route('settings.journal.voucher.create') }}"><i
                                    class="fas fa-plus"></i>
                                Add New</a>
                        @endif
                ...
                <form class="needs-validation" id="getform" method="POST"
                    action="{{ route('settings.journal.voucher.update', $editInfo->id) }}">
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            {{-- <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control select2" name="credit_account_id" id="credit_account_id">
                                    ...
                                    <option {{ $editInfo->account_id == "14" ? "selected":"" }} value="14">Due</option>
                                </select>
