                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @if (helper::roleAccess('settings.dabit.voucher.index'))
                            <li class="breadcrumb-item"><a href="{{ route('settings.dabit.voucher.index') }}">Payment
                                    Voucher</a></li>
                        @endif
                        <li class="breadcrumb-item active"><span>Payment Voucher List</span></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@endsection
@section('scripts')
    @include('backend.pages.settings.dabit_voucher.script')
@endsection
