        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('settings.branch.index') }}">Branch</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Branch List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
@endsection
@section('scripts')
@include('backend.pages.settings.branch.script')
@endsection