        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Invoice</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if (helper::roleAccess('project.invoiceCreate.index'))
                    <a class="btn btn-default" href="{{ route('project.invoiceCreate.index') }}"><i
                            class="fa fa-list"></i>
                        Invoice List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('project.invoiceCreate.store') }}"
                    novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <span class="bg-green" style="padding: 5px; font-weight : bold"
                                for="validationCustom01">Invoice Code * : {{ $projectCode }}</span>
                            <input type="hidden" name="invoiceCode" class="form-control" id=""
                                value="{{ $projectCode }}">
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="profit" class="form-control" id="validationCustom01"
                                placeholder="0000" value="{{ old('profit') }}">
                            @error('profit')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="total_value" class="form-control" id="validationCustom01"
                                placeholder="0000" value="{{ old('total_value') }}">
                            @error('total_value')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
