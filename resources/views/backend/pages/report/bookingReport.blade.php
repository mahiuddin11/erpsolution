        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><span>Booking Report</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
$(document).ready(function() {
    listResult($('.daterange').val(), $('.merchent_id').val(), $('.status_id').val());
    ...
    function listResult(daterange, merchent_id, status_id) {
        $.ajax({
            type: 'get',
            url: "{{ route('report.booking.result') }}",
            data: {
                daterange: daterange,
