        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('inventorySetup.adjustDeposit.index')}}">Adjustment
                            List</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Edit Deposit</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Deposit Adjustment Edit</h3>
                <div class="card-tools">
                    @if(helper::roleAccess('settings.adjustDeposit.create'))
                    <a class="btn btn-default" href="{{ route('inventorySetup.adjustDeposit.create') }}"><i
                            class="fas fa-plus"></i>
                        Add New</a>
                    @endif
            ...
            <div class="card-body">
                <form class="needs-validation" method="POST"
                    action="{{ route('inventorySetup.adjustDeposit.update',$adjusts->id) }}" novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label>Date:</label>
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" name="date" data-toggle="datetimepicker" value="{{$adjusts->date}}"
...
{{-- 
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="bank_name" value="{{$adjusts->bank_name}}" placeholder="Check no"
                                class="form-control">
                            @error('bank_name')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                <input type="text" name="check_date" data-toggle="datetimepicker"
                                    value="{{$adjusts->check_date}}" class="form-control datetimepicker-input"
                        ...
                        {{-- <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="check_no" value="{{$adjusts->check_no}}" placeholder="Check no"
                                class="form-control">
                            @error('check_no')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control select2" name="branch_id">
                                ...
                                <option {{$adjusts->branch_id==$value->id? 'selected':''}} value="{{$value->id}}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control select2" name="account_id">
                                <option disabled value="">--Select--</option>
                            <x-account :setAccounts="$account" :selectVal="$adjusts->account_id"  />
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control select2" name="customer_id">
                                ...
                                <option {{$adjusts->customer_id==$value->id? 'selected':''}} value="{{$value->id}}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="amount" value="{{$adjusts->debit}}" id="amount"
                                class="form-control" placeholder="Amount" value="{{ old('amount') }}" required>
                            @error('amount')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="expire_date" value="{{$adjusts->expire_date}}" class="form-control"
