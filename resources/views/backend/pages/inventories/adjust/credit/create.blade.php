    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Add New Credit Adjust</h3>
                <div class="card-tools">
                    @if (helper::roleAccess('inventorySetup.adjustCredit.index'))
                    <a class="btn btn-default" href="{{ route('inventorySetup.adjustCredit.index') }}"><i class="fa fa-list"></i>
                        Adjust List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('inventorySetup.adjustCredit.store') }}" novalidate>
                    @csrf
                    <div class="form-row">
                        ...
                        <div id="expireddate" class="col-md-4 mb-3">
                            <label>Expire Date:</label>
                            <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                <input type="text" name="expire_date" data-toggle="datetimepicker" value="{{ date('Y-m-d') }}" class="form-control datetimepicker-input" data-target="#reservationdate1" />
