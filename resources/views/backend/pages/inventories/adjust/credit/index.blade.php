        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-default" href="{{ route('inventorySetup.adjustCredit.create') }}"><i class="fas fa-plus"></i>Add New</a>
                    @endif
...
@endsection
@section('scripts')
@include('backend.pages.inventories.adjust.credit.script')
@endsection