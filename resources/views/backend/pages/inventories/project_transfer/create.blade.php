        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('project.transferproject.index') }}">Purchase
                        </a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Project Transfer</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Add New Project Transfer</h3>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('project.transferproject.store') }}"
                    novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <span class="bg-green" style="padding: 5px; font-weight : bold"
                                for="validationCustom01">Project Transfer Code * : {{ $requisitionCode }}</span>
                    ...
                    <button class="btn btn-info btn_submit" type="submit"><i class="fa fa-save"></i> &nbsp;Save</button>
                </form>
            </div>
            <!-- /.card-body -->
            ...
            $.ajax({
                ...
                success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            if(value == '<span class="error text-red text-bold">product not available in stock!!</span>'){
            ...
            if (qty == '' || qty == null || qty == 0) {
                ...
                const row = `
                    <tr class="new_item${proId}">
                        ...
                        <td class="text-right">
                            <input type="number" class="form-control qnty" name="qty[]" value="${qty}">
                            <div class="productStockCheck${proId}"></div>
                        </td>
