...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('inventorySetup.stockAdjustment.storeapproval', $editInfo->id) }}" novalidate>
                    @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 " name="adjustment_type">
                                    ...
                                    <option value="Gain" {{ $editInfo->adjustment_type == 'Gain' ? 'selected' : '' }}>
                                        Gain</option>
                                    <option value="Lost" {{ $editInfo->adjustment_type == 'Lost' ? 'selected' : '' }}>
                                        Lost</option>
                        ...
                        <table class="table table-bordered table-hover" id="show_item">
                            ...
                            <tbody>
                                ...
                                <tr class="new_item">
                                    ...
                                    <td class="text-right">
                                        <input type="number" class="ttlqty qnty form-control" name="qty[]" value="{{ $detail->quantity }}">
                                    </td>
                                    <td class="text-right">
                                        {{ $detail->unit_price }}
                                        <input type="hidden" class="ttlunitprice unitprice" id="unitprice" name="unitprice[]" value="{{ $detail->unit_price }}">
                                    </td>
                                    <td class="text-right">
                                        <input type="text" readonly class="total form-control" id="total" name="total[]" value="{{ $detail->total_price }}">
                                    </td>
                                    <td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right"><strong class="ttlqty">{{ $editInfo->quantity ?? 0 }}</strong>
                                    </td>
                                    <td class="text-right"><strong class="ttlunitprice">{{ $editInfo->subtotal ?? 0 }}</strong></td>
                                    <td class="text-right"><strong class="grandtotal">{{ $editInfo->grand_total ?? 0 }}</strong></td>
                                    <td class="text-right"><strong class=""></strong></td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <div class="col-md-3">
                            ...
                            <table class="table table-bordered table-hover" id="cart_output">
                                <tr>
                                    ...
                                    <th width="35%" class="text-right"><span class="grandtotal">{{ $editInfo->grandtotal }}</span>
                                    </th>
                                    <th></th>
                                </tr>
