        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Stock
                        Adjustment List</h3>
                    <div class="card-tools">
                        @if (helper::roleAccess('inventorySetup.stockAdjustment.create'))
                            <a class="btn btn-default" href="{{ route('inventorySetup.stockAdjustment.create') }}"><i
...
@endsection
@section('scripts')
    @include('backend.pages.inventories.stockAdjustment.script')
@endsection
