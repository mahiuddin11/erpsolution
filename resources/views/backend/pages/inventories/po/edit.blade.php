            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @endif
                        <li class="breadcrumb-item active"><span>Edit Purchase Order</span></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('admin-content')
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form class="needs-validation" method="POST"
                        action="{{ route('inventorySetup.purchaseorder.update', $editInfo->id) }}" novalidate>
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <select class="form-control select2" name="subblier_id">
                                <option selected disabled value="">--Select--</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select readonly id="project_id" class="form-control select2" name="project_id">
                                    <option selected value="{{ $editInfo->project_id }}">
                                        {{ $editInfo->project->name ?? 'N/A' }}
                                    </option>
                                </select>
                                @error('project_id')
                                    <span class=" error text-red text-bold">{{ $message }}</span>
                            ...
                            <tbody id="main-table">
                                ...
                                @foreach ($editInfo->details as $value)
                                    ...
                                    <tr class="delrow new_item{{ $value->product_id }}">
                                        ...
                                        <td class="text-right"> <input readonly class="form-control" type="text"
                                                name="purchasetype[]" value="{{ $value->purchasetype }}"></td>

                                        <td class="text-right"> <input class="ttlqty qnty form-control" type="number"
                                                name="qty[]" value="{{ $value->qty }}"></td>

                                        <td class="text-right"><button class="btn btn-info supplierButton" type="button"
                                                order-id="{{ $value->id }}" btn-id="{{ $value->product_id }}"> <i
                        ...
                        {{-- <div class="modelappend">
                            @foreach ($purchaseOrderDtls as $proDetail)
                                <div class="modal fade setModelName" id="model{{ $proDetail->product_id }}"
                                   role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Supplyer Offer Price</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        ...
                                                        <select class="form-control select2"
                                                            name="supplier_{{ $proDetail->product_id }}[]">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input type="number"
                                                            name="amount_{{ $proDetail->product_id }}[]"
                                                            value=""
                                                            class="form-control">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <button class="btn btn-success btn-sm addsupplier mt-4"
                                                            type="button"><i class="fa fa-plus"></i></button>
                                                        <button class="btn btn-danger btn-sm removeSupplier mt-4"
                                                            type="button"><i class="fa fa-minus"></i></button>
                                                    </div>
                                                </div>
                                                @foreach ($selectedSupplier as $supplier)
                                                    @if ($proDetail->id == $supplier->purchase_order_id)
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <label for="validationCustom01">Supplier * :</label>
                                                                <select class="form-control select2"
                                                                    ...
                                                                    @foreach ($suppliers as $key => $value)
                                                                        <option value="{{ $value->id }}"
                                                                            {{ $supplier->supplier_id == $value->id ? 'selected' : '' }}>
                                                                            {{ $value->supplierCode . ' - ' . $value->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <input type="number"
                                                                    name="amount_{{ $proDetail->product_id }}[]"
                                                                    value="{{ $supplier->purchases_price }}"
                                                                    class="form-control">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <button class="btn btn-success btn-sm addsupplier mt-4"
                            ...
                            @foreach ($purchaseOrderDtls as $proDetail)
                                ...
                                <div class="modal fade setModelName" id="model{{ $proDetail->product_id }}"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Supplier Offer Price</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                @php
                                                    // new add: get all supplier/account/customer rows for this product
                                                    $selectedList = $selectedSupplier->where(
                                                        'purchase_order_id',
                                                        $proDetail->id,
                                                    );
                                                @endphp
                                                ...
                                                @foreach ($selectedList as $selected)
                                                    <div class="row supplier-amount-row">
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            @elseif(!empty($selected->account_id))
                                                                <label>supplier</label>
                                                                <select class="form-control select2"
                                                                    name="account_{{ $proDetail->product_id }}[]">
                                                        ...
                                                        <div class="col-md-2 d-flex align-items-end">
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-danger btn-sm removeSupplier ml-1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //                          <div class="col-md-5">
            //                              <label for="validationCustom01">Supplier * :</label>
            //                           <select class="form-control SupID select2" name="supplier_${id}[]">
            //                                   <option selected disabled value="">--Select--</option>
            //                                   @foreach ($suppliers as $key => $value)
            //                                     <option value="{{ $value->id }}">
            //                                         {{ $value->supplierCode . ' - ' . $value->name }}
            ...
            //                          <div class="col-md-5">
            //                              <label for="validationCustom01">Amount * :</label>
            //                            <input type="number" name="amount_${id}[]" value="${price}" class="form-control">
            //                          </div>
            //                          <div class="col-md-2">
            //                            <button class="btn btn-success addsupplier mt-4" type="button"><i class="fa fa-plus"></i></button>
...
<div class="modal fade setModelName" id="model${id}" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row supplier-amount-row">
                    ...
                    <div class="col-md-5">
                        <label>Supplier</label>
                        <select class="form-control SupID select2" name="account_${id}[]">
                    ...
                    <div class="col-md-5">
                        <label>Amount</label>
                        <input type="number" name="amount_${id}[]" class="form-control">
                    </div>

                    <div class="col-md-2 mt-4">
                        <button class="btn btn-success btn-sm addsupplier" type="button">
                            <i class="fa fa-plus"></i>
                        </button>

                        <button class="btn btn-danger btn-sm removeSupplier" type="button">
                            <i class="fa fa-minus"></i>
                        </button>
                    </div>
...
`;
            ...
            //         $('#model' + productid).modal('toggle');
            //     }
            //     $('.SupID').select2(); // Initialize select2 for the dynamically added select
            // });
            ...
            $(document).on('click', '.supplierButton', function() {
                ...
                // console.log("Modal exist:", $("#model" + productid).length);

                if ($("#model" + productid).length == 0) {
                    let model = htmlmodel(productid);
                    $('.modelappend').append(model);

                    // new add: wait for DOM render
                    setTimeout(function() {
                        $("#model" + productid).modal('show');
                        $('#model' + productid + ' .select2').select2({
                            width: '100%'
                        });
                    }, 100);
                } else {
