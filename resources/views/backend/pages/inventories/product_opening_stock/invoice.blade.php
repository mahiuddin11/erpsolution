        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('inventorySetup.productOS.index') }}">Product Opening Stock</a>
                    </li>
                    @endif
                    <li class="breadcrumb-item active"><span>Product Opening Stock List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Product Opening Stock Invoice</h3>
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-6 invoice-col" style="text-align: center;">
                            <b style="font-size : 20px ;white-space: nowrap;">{{ $companyInfo->company_name ?? 'N/A' }}</b>
                            <address>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $detail->product->getRawOriginal('name') ?? 'N/A' }}</td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            {{ number_format($totalPrice, 2) ?? 'N/A' }}</th>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
