            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @endif
                        <li class="breadcrumb-item active"><span>Add New Product Opening Stock</span></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Add New Product Opening Stock</h3>
                    <div class="card-tools">
                        @if (helper::roleAccess('inventorySetup.productOS.index'))
                            <a class="btn btn-default" href="{{ route('inventorySetup.productOS.index') }}"><i
                                    class="fa fa-list"></i>
                                Product Opening Stock List</a>
                        @endif
                ...
                <div class="card-body">
                    <form class="needs-validation" id="getform" method="POST"
                        action="{{ route('inventorySetup.productOS.store') }}" novalidate>
                        @csrf
                        <div class="form-row">
