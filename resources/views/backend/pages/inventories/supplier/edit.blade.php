        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('inventorySetup.supplier.index')}}">Supplier List</a>
                    </li>
                    @endif
                    <li class="breadcrumb-item active"><span>Edit Supplier</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-default" href="{{ route('inventorySetup.supplier.create') }}"><i
                            class="fas fa-plus"></i>
                        Add New</a>
                    @endif
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" method="POST"
                    action="{{ route('inventorySetup.supplier.update',$editInfo->id) }}" novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Supplier Name * :</label>
                            <input type="text" name="name" class="form-control" id="validationCustom01"
                                placeholder="Supplier Name" value="{{ $editInfo->name }}">
                            @error('name')
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom01">BIN Number :</label>
                            <input type="text" name="specialNumber" class="form-control" id="validationCustom01"
                                placeholder="BIN Number" value="{{ $editInfo->specialNumber  }}" required>
                            @error('specialNumber')
                            <span class=" error text-red text-bold">{{ $message }}</span>
                            @enderror
                        </div>
