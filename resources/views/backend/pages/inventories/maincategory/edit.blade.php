                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @if (helper::roleAccess('inventorySetup.maincategory.index'))
                            <li class="breadcrumb-item"><a href="{{ route('inventorySetup.maincategory.index') }}">Main Category
                                    List</a></li>
                        @endif
                        <li class="breadcrumb-item active"><span>Edit Main Category</span></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @if (helper::roleAccess('inventorySetup.maincategory.create'))
                            <a class="btn btn-default" href="{{ route('inventorySetup.maincategory.create') }}"><i
                                    class="fas fa-plus"></i>
                                Add New</a>
                        @endif
                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST"
                        action="{{ route('inventorySetup.maincategory.update', $editInfo->id) }}" novalidate>
                        @csrf
                        <div class="form-row">
