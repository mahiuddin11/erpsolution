            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @if (helper::roleAccess('inventorySetup.purchaserequisition.index'))
                            <li class="breadcrumb-item"><a
                                    href="{{ route('inventorySetup.purchaserequisition.index') }}">Customer
                                    List</a></li>
                        @endif
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @if (helper::roleAccess('inventorySetup.purchaserequisition.index'))
                            <a class="btn btn-default" href="{{ route('inventorySetup.purchaserequisition.index') }}"><i
                                    class="fa fa-list"></i>
                ...
                <div class="card-body">
                    <form class="needs-validation" method="POST"
                        action="{{ route('inventorySetup.purchaserequisition.store') }}" novalidate>
