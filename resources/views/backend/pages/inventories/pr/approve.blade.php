                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @if (helper::roleAccess('inventory-purchaserequisition-list'))
                            <li class="breadcrumb-item"><a href="{{ route('inventory-purchaserequisition-list') }}">Customer
                                    List</a></li>
                        @endif
                        <li class="breadcrumb-item active"><span>Approve Purchase Requisition</span></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Approve Purchase Requisition</h3>
                ...
                <div class="card-body">
                    <form class="needs-validation" method="POST"
                        action="{{ route('inventorySetup.purchaserequisition.update', $requisition->id) }}" novalidate>
                        @csrf
                        <div class="form-row">
                            ...
                            <tbody>
                                ...
                                @foreach ($requisitionDetails as $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->purchasetype }} <input type="hidden" name="purchasetype[]"
                                                value="{{ $value->purchasetype }}"></td>
                                        <td>{{ $value->qty }} <input type="hidden" name="qty[]"
                                                value="{{ $value->qty }}"></td>
                                        {{-- <td>{{ $value->unit_price }} <input type="hidden" name="unitprice[]"
                                                value="{{ $value->unit_price }}"></td>
                                        <td>{{ $value->total_price }} <input type="hidden" name="total[]"
                        ...
                        <div class="form-row form-group">
                            ...
                            <a class="btn btn-success" href="{{route('inventorySetup.purchaserequisition.approveUpdate',$requisition->id)}}"><i class="fa fa-save"></i> &nbsp;Approve</a>
                    </form>
                </div>
                <!-- /.card-body -->
