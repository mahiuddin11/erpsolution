                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control select2 supid" id="supplier_id" name="supplier_id">
                                ...
                                <option {{ $editInfo->supplier_id == $value->id ? 'selected':''}} value="{{ $value->id
                                    }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="accounts" class="form-control select2 accounts">
                                            ...
                                            <option value="{{ $account->id }}" {{ $editInfo->chart_of_account_id ==
                                                $account->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="account_number" type="text" class="form-control"
                                            placeholder="Ex:1234234" value="{{ $editInfo->account_number ?? '' }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea cols="100" rows="3" class="form-control" name="narration"
                                        placeholder="Narration" type="text">{{ $editInfo->narration ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <table class="table table-bordered table-hover" id="cart_output">
                                <tr>
                                    ...
                                    <th class="text-right"><span class="grandtotal">{{ $editInfo->grandtotal }}</span>
                                    </th>
                                </tr>
                                <tr class="d-none">
                                    <th><span>Advance(-)</span></th>
                                    <th class="text-right">
                                        <input type="number" step="any" value="{{$purchaseOrder->advance_payment}}"
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">
                                        <input type="number" step="any" class="form-control discount input-checker"
                                            name="discount" placeholder="Ex:5" value="{{ $editInfo->discount ?? '' }}">
                                        @error('discount')
                                        <span class=" error text-red text-bold">{{ $message }}</span>
                                        @enderror
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><span class="cart_net_total">{{ $editInfo->net_total ?? 0
                                            }}</span></th>
                                </tr>
                                <tr id="payamount" class="{{ $editInfo->payment_type == "due" ? "d-none" : "" }}">
                                    ...
                                    <th class="text-right">
                                        <input type="number" step="any" class="form-control paid_amount input-checker"
                                            name="paid_amount" placeholder="Ex:5" value="{{ abs($total) ?? 0 }}">
                                ...
                                {{-- <tr>
                                    ...
                                    <th class="text-right"><span class="cart_due">{{ $editInfo->due_amount ?? 0
                                            }}</span>
                                    </th>
                                </tr> --}}
                            </table>
