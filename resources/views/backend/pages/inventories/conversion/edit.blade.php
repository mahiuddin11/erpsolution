                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @if (helper::roleAccess('inventorySetup.conversion.index'))
                            <li class="breadcrumb-item"><a href="{{ route('inventorySetup.conversion.index') }}">conversion
                                    List</a></li>
                        @endif
                        <li class="breadcrumb-item active"><span>Edit conversion</span></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST"
                        action="{{ route('inventorySetup.conversion.update', $editInfo->id) }}" novalidate>
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="rate" class="form-control" id="validationCustom01"
                                    placeholder="ID" value="{{ $editInfo->rate }}">
                                @error('rate')
                                    <span class=" error text-red text-bold">{{ $message }}</span>
                                @enderror
                            </div>
