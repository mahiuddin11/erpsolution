                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @if (helper::roleAccess('inventorySetup.purchaseorder.index'))
                            <li class="breadcrumb-item"><a
                                    href="{{ route('inventorySetup.purchaseorder.index') }}">Purchase</a>
                            </li>
                        @endif
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('inventorySetup.goodrcvnote.store') }}"
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="hidden" name="grnCode" class="form-control" id=""
                                    value="{{ $grnInv }}">
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <table class="table table-bordered table-hover" id="show_item">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class=""><strong class=""></strong></td>
                                    <td class=""><strong class="ttlqty"></strong></td>
                                    <td class=""><strong class="approvett"></strong></td>
                                    <td class=""><strong class="remainingtt"></strong></td>
                                    <td class=""><strong class="ttlunitprice"></strong></td>
                                    <td class=""><strong class="grandtotal"></strong></td>
                                </tr>
                            </tfoot>
                        </table>
