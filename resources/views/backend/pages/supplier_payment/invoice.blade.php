                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col" style="text-align:right">
                            <b style="text-decoration: underline">Payment Invoice </b><br>
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="5">In words :
                                            @php
                                            if(!empty($invoice->credit)){
                                            echo Terbilang::make($invoice->credit);
                                            }else{
                                            echo Terbilang::make($invoice->debit) ;
                                            }
                                            @endphp
                                        </th>
                                    </tr>
                                    <tr>
                                        <td colspan="5">Narration: {{ $invoice->narration ?? 'N/A' }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
