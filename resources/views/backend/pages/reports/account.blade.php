...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('report.account.account') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-12 table-responsive">
                            ...
                            <table id="datatablexcel" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $creditTotal =0;
                                    @endphp
                                    @foreach ($accountDetails as $item)
                                    ...
                                    <tr>
                                        <td>{{ $i++; }}</td>
                                        <td>{{ $item->date}}</td>
                                        <td>{{ $item->accountCode .' - '.$item->account_name }}</td>
                                        <td>{{ $item->branchCode .' - '.$item->name }}</td>
                                        <td>
                                            {{config('type')[$item->type] ?? "Nothing Found"}}
                                        </td>
