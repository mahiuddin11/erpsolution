    ...
    <div class="row">
        <div class="col-md-12 no-print">
            <div class="card card-default">
                <div class="card-body">
                    <form action="{{ route('report.bank_book') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="account_id" id="account_id" class="form-control select2">
                                        <x-account :setAccounts="$accounts" :skip="[getAccountByUniqueID(7)->id]"/>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header no-print">
                        <h3 class="card-title">Bank Book Report</h3>
                                    ...
                                    <table class="table  table-bordered">
                                        <tr>
                                            ...
                                            <td width="70%" style="text-align: center">
                                                <h3>{{$account->bank_name}}  {{ $account->account_code}}</h3>
                                    ...
                                    <table class="table table-bordered mt-2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ number_format(collect($ledgerEntries)->sum("debit")) }}</td>
                                                <td>{{ number_format(collect($ledgerEntries)->sum("credit")) }}</td>
