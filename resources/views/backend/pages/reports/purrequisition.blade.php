...
<div class="row">
    ...
    <div class="col-md-12">
        <form action="{{ route('report.purchase.pr') }}" method="POST" id="stocksub" enctype="multipart/form-data">
            @csrf
    ...
    @endphp
    @if (isset($requisitionDetails) && !empty($requisitionDetails))
    <div class="col-md-12">
                        ...
                        <div class="col-12 table-responsive">
                            <table class="table  table-bordered">
                                <tr>
                                    ...
                                    <td width="70%" style="text-align: center">
                                        <h3>Purchase Requisition Report</h3>
                            ...
                            <table id="datatablexcel" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    @foreach ($requisitionDetails as $item)
