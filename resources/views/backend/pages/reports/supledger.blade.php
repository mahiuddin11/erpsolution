...
<div class="row">
    ...
    <div class="col-md-12">
        <form action="{{ route('report.supledger.supledger')}}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 " name="supplier_id">
                                    ...
                                    <option {{ $supplier_id==$value->id ? 'selected' : '' }} value="{{ $value->id}}">
    ...
    @if (isset($supplierLedger) && !empty($supplierLedger))
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header no-print">
                <h3 class="card-title">Supplier ledger Report</h3>
                        ...
                        <div class="col-12 table-responsive">
                            ...
                            <table id="datatablexcel" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $creditTotal =0;
                                    @endphp
                                    @foreach ($supplierLedger as $item)
