...
@section('admin-content')
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('report.employee.salary') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="employee_id">
                                        ...
                                        <option {{$employee_id == $value->id ? "selected":""}} value="{{$value->id}}">{{$value->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('employee_id')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="account_id">
                                        <option selected value="all">ALL Account</option>
                                        @foreach ($accounts as $value)
                                        <option {{$account_id == $value->id ? "selected":""}} value="{{$value->id}}">{{$value->account_name}}</option>
                                        @endforeach
                                    </select>
                                    @error('account_id')
                                    <span class="error text-red text-bold"> {{ $message }}</span>
        ...
        @if (isset($employeeLedger) && !empty($employeeLedger))
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header no-print">
                    <h3 class="card-title">Employee ledger Report</h3>
                                ...
                                <table id="datatablexcel" class="table table-striped table-bordered">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2" style="text-align: right;">{{ $debitTotal - $creditTotal}}</th>
                                        </tr>
                                    </tfoot>
