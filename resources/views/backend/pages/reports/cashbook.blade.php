    ...
    <div class="row">
        <div class="col-md-12 no-print">
            <div class="card card-default">
                <div class="card-body">
                    <form action="{{ route('report.cashbook.cashbook') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="account_id" id="account_id" class="form-control select2">
                                        <x-account :setAccounts="$accounts" :skip="[getAccountByUniqueID(8)->id]" />
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
        ...
        @if (isset($ledgerEntries) && !empty($ledgerEntries))
            <div class="col-md-12">
                <div class="card card-default">
