...
<div class="row">
    ...
    <div class="col-md-12">
        <form action="{{ route('report.custledger.custledger')}}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 " name="customer_id" required>
                                    ...
                                    <option {{ $customer_id==$value->id ? 'selected' : '' }} value="{{ $value->id}}">
    ...
    @if (isset($customerLedger) && !empty($customerLedger))
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header no-print">
                <h3 class="card-title">Customer ledger Report</h3>
                ...
                <div class="invoice p-3 mb-3">
                    <div class="row">
                        <div class="col-12 table-responsive">
                            ...
                            <table id="datatablexcel" class="table  table-bordered">
                                <thead>
                                    <tr>
                                        <th colspan="10">
                                            <i class="fa fa-circle"></i> Ledger Details
                                        </th>
                                    </tr>
                                    <tr>
                                        <th>SL</th>
                                ...
                                <tbody>
                                    ...
                                    $creditTotal =0;
                                    @endphp
                                    @foreach ($customerLedger as $item)
                                    @if ($item->account_id != 5)
                                    @php
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th style="text-align: right;">{{ $debitTotal}}</th>
                                        <th style="text-align: right;">{{ $creditTotal}}</th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" style="text-align: center">Remaining</th>

                                        <th colspan="2" style="text-align: right;">{{ $creditTotal - $debitTotal}}</th>
                                    </tr>
                                </tfoot>
