...
Route::group(['prefix' => 'admin', 'namespace' => 'Backend'], function () {
    ...
    Route::group(['middleware' => ['web', 'auth'], 'namespace' => 'Project'], function () {
        ...
        // Route::post('/project-bill-stor', [ProjectController::class, 'billStor'])->name('project.bill.store');
        // Route::get('/project-bill-feed/{id}', [ProjectController::class, 'billFeed'])->name('project.bill.feed');
